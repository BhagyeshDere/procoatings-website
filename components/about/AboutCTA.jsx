      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          ...
          <div className="max-w-2xl">
            <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6 text-[#0D2B45]">
              Start your next <br />
          ...
          {/* Interactive Button Wrapped in Link */}
          <Link href="/contact" className="group">
            <div className="flex items-center gap-6 md:gap-8 text-xl md:text-2xl font-black uppercase tracking-tighter text-[#0D2B45] hover:text-[#F5A623] transition-colors text-left md:text-right cursor-pointer">
