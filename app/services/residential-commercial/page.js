...
const systems = [
{
title:"Car Deck Parking Systems",
tag:"Traffic Deck",
image:"/images/commercial/car-deck.jpg",
icon:ParkingCircle,
desc:"Heavy duty car park deck protection systems designed for traffic abrasion, waterproofing and long service life.",
features:[
"Vehicular Wear Resistance",
"Deck Waterproofing",
"Anti-Slip Safety"
]
},
...
tag:"Safety Flooring",
image:"/images/commercial/anti-skid.jpg",
icon:ShieldCheck,
desc:"Slip resistant performance flooring solutions engineered for safety-critical commercial and residential zones.",
features:[
"Slip Resistance",
"Textured Safety Finish",
"High Durability"
]
},

{
title:"Textured PU Flooring",
tag:"Decorative Performance",
image:"/images/commercial/pu-floor.jpg",
icon:Layers3,
desc:"Decorative polyurethane flooring with resilient textured finishes for premium commercial and residential spaces.",
features:[
"Decorative Finish",
"Comfort Underfoot",
"Seamless Protection"
...
Decorative and performance flooring solutions
for residential, commercial and traffic deck applications.
</p>
...
<span className="bg-[#EAA33F] text-[#0F3250] px-5 py-2 rounded-full font-black shadow-lg">
{item.tag}
</span>
...
<button className="flex items-center gap-3 font-black text-[#0F3250] hover:text-[#EAA33F] transition">
Technical Details
<ArrowRight />
</button>

<div className="flex gap-2">
<span className="w-3 h-3 rounded-full bg-[#EAA33F]" />
<span className="w-3 h-3 rounded-full bg-[#0F3250]/20" />
<span className="w-3 h-3 rounded-full bg-[#0F3250]/20" />
</div>
...
{[
["Car Deck","Traffic Systems"],
["Anti-Skid","Safety Floors"],
["PU Textured","Premium Finish"]
].map((item,i)=>(
<div
key={i}
...
<div
key={i}
className="bg-slate-50 rounded-3xl shadow-xl p-10 text-center"
>
<Building2
...
Speak with our specialists for customized flooring solutions.
</p>
