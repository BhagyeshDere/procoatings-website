...
style={{
backgroundImage:
`linear-gradient(#EAA33F 1px, transparent 1px),
...
High-performance chemical defense systems
for corrosion control thermal isolation
and fire safety.
</p>
...
group-hover:bg-[#EAA33F]
group-hover:text-[#0F3250]
transition-colors
">
<item.icon size={20}/>
</div>
...
<Link
href={{
pathname:`/services/protective-coatings/${item.slug}`
}}
prefetch={false}
className="
inline-flex items-center gap-2
...
<span className="
block text-[9px]
font-black text-[#EAA33F]
mb-2 uppercase opacity-50
">
Matrix 0{i+1}
</span>
